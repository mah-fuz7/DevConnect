...
const SignIn = () => {
  const {EmailPasswordFunc,signInWithGoogleFunc,signInWithGithubFunc}=useContext(AuthContext)
  ...
  const handleSignin = (e) =>{
    ...
    EmailPasswordFunc(email,password)
    .then(result => {
    ...
    console.log("btn click", {email,password})
  }
          ...
          <div className="hero-content flex-col lg:flex-row-reverse">
            ...
            <div className="card bg-base-100 w-full max-w-sm shrink-0 shadow-2xl">
              <div className="card-body">
                ...
                {/* Google */}
<button onClick={handleGoogleSignIn} type="submit" className="btn bg-white text-black border-[#e5e5e5]">
